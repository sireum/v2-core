...
class KonkritTransformationEvaluatorTest
    extends TransformationEvaluatorTestFramework[BasicState, BasicState, ISeq[BasicState]]
    with KonkritActionEvaluatorTestCases[BasicState, BasicState, ISeq[BasicState]]
    with KonkritJumpEvaluatorTestCases[BasicState, BasicState, ISeq[BasicState]]
    with KonkritTransformationEvaluatorTestCases[BasicState, BasicState, ISeq[BasicState]] {

...
export EGIT_DROP_URL=${EGIT_URL:=http://ftp.osuosl.org/pub/eclipse/egit/updates/org.eclipse.egit.repository-}${EGIT_VERSION:=3.7.1}.${EGIT_BUILD_DATE:=201504261725}-r.zip

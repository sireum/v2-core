...
public final class FunctionBodyStub extends SubProgramBodyStub {
  protected FunctionSpecification theFunctionSpecification;

  protected FunctionAnnotation theOptionalFunctionAnnotation;

  public final static int DESCRIPTOR = 137;

  public FunctionBodyStub() {
  }

  @Override
  public final int getDescriptor() {
    return FunctionBodyStub.DESCRIPTOR;
  }

...
public final class SignedIntegerTypeDefinition extends IntegerTypeDefinition {
  protected Exp theLowRangeExp;

  protected Exp theHighRangeExp;

  public final static int DESCRIPTOR = 13;

  public SignedIntegerTypeDefinition() {
  }

  @Override
  public final int getDescriptor() {
    return SignedIntegerTypeDefinition.DESCRIPTOR;
  }

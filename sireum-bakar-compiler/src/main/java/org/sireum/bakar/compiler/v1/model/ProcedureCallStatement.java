...
public final class ProcedureCallStatement extends SimpleStatement {
  protected Name theName;

  protected ParameterAssociationList theOptionalParameterAssociationList;

  public final static int DESCRIPTOR = 107;

  public ProcedureCallStatement() {
  }

  @Override
  public final int getDescriptor() {
    return ProcedureCallStatement.DESCRIPTOR;
  }

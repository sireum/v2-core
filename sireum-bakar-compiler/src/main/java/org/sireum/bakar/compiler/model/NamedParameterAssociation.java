...
public final class NamedParameterAssociation extends Node {
  protected String theIDString;

  protected Exp theExp;

  public final static int DESCRIPTOR = 110;

  public NamedParameterAssociation() {
  }

  @Override
  public final int getDescriptor() {
    return NamedParameterAssociation.DESCRIPTOR;
  }

// Do not edit this file. It is auto-generated from org.sireum.core.module.Pdg
...
object PdgModule extends PipelineModule {
  ...
  def compute(job : PipelineJob, info : PipelineJobModuleInfo) : MBuffer[Tag] = {
    ...
    try {
      val module = Class.forName("org.sireum.core.module.PdgModuleDef")
  ...
  override def validPipeline(stage : PipelineStage, job : PipelineJob) : MBuffer[Tag] = {
    val tags = marrayEmpty[Tag]
    val deps = ilist[PipelineModule](CfgModule, CfgModule, DdgModule, CdgModule)
    deps.foreach(d =>
  ...
  def getPool(options : scala.collection.Map[Property.Key, Any]) : scala.collection.mutable.Map[org.sireum.alir.AlirIntraProceduralNode, org.sireum.alir.AlirIntraProceduralNode] = {
    ...
    if (options.contains(PdgModule.poolKey)) {
      return options(PdgModule.poolKey).asInstanceOf[scala.collection.mutable.Map[org.sireum.alir.AlirIntraProceduralNode, org.sireum.alir.AlirIntraProceduralNode]]
    }
  ...
  def getCfg(options : scala.collection.Map[Property.Key, Any]) : org.sireum.alir.ControlFlowGraph[java.lang.String] = {
    ...
    if (options.contains(PdgModule.cfgKey)) {
      return options(PdgModule.cfgKey).asInstanceOf[org.sireum.alir.ControlFlowGraph[java.lang.String]]
    }
  ...
  def getDdg(options : scala.collection.Map[Property.Key, Any]) : org.sireum.alir.DataDependenceGraph[java.lang.String] = {
    ...
    if (options.contains(PdgModule.ddgKey)) {
      return options(PdgModule.ddgKey).asInstanceOf[org.sireum.alir.DataDependenceGraph[java.lang.String]]
    }
  ...
  def getCdg(options : scala.collection.Map[Property.Key, Any]) : org.sireum.alir.ControlDependenceGraph[java.lang.String] = {
    ...
    if (options.contains(PdgModule.cdgKey)) {
      return options(PdgModule.cdgKey).asInstanceOf[org.sireum.alir.ControlDependenceGraph[java.lang.String]]
    }
  ...
  def setPdg(options : MMap[Property.Key, Any], pdg : org.sireum.alir.ProgramDependenceGraph[java.lang.String]) : MMap[Property.Key, Any] = {
  ...
  object ConsumerView {
    implicit class PdgModuleConsumerView(val job : PropertyProvider) extends AnyVal {
      def pool : scala.collection.mutable.Map[org.sireum.alir.AlirIntraProceduralNode, org.sireum.alir.AlirIntraProceduralNode] = PdgModule.getPool(job.propertyMap)
      def cfg : org.sireum.alir.ControlFlowGraph[java.lang.String] = PdgModule.getCfg(job.propertyMap)
      def ddg : org.sireum.alir.DataDependenceGraph[java.lang.String] = PdgModule.getDdg(job.propertyMap)
      def cdg : org.sireum.alir.ControlDependenceGraph[java.lang.String] = PdgModule.getCdg(job.propertyMap)
      def procedureSymbolTable : org.sireum.pilar.symbol.ProcedureSymbolTable = PdgModule.getProcedureSymbolTable(job.propertyMap)
      def pdg : org.sireum.alir.ProgramDependenceGraph[java.lang.String] = PdgModule.getPdg(job.propertyMap)
    }
  }

  object ProducerView {
    implicit class PdgModuleProducerView(val job : PropertyProvider) extends AnyVal {

      def pool_=(pool : scala.collection.mutable.Map[org.sireum.alir.AlirIntraProceduralNode, org.sireum.alir.AlirIntraProceduralNode]) { PdgModule.setPool(job.propertyMap, pool) }
      def pool : scala.collection.mutable.Map[org.sireum.alir.AlirIntraProceduralNode, org.sireum.alir.AlirIntraProceduralNode] = PdgModule.getPool(job.propertyMap)

      def cfg_=(cfg : org.sireum.alir.ControlFlowGraph[java.lang.String]) { PdgModule.setCfg(job.propertyMap, cfg) }
      def cfg : org.sireum.alir.ControlFlowGraph[java.lang.String] = PdgModule.getCfg(job.propertyMap)

      def ddg_=(ddg : org.sireum.alir.DataDependenceGraph[java.lang.String]) { PdgModule.setDdg(job.propertyMap, ddg) }
      def ddg : org.sireum.alir.DataDependenceGraph[java.lang.String] = PdgModule.getDdg(job.propertyMap)

      def cdg_=(cdg : org.sireum.alir.ControlDependenceGraph[java.lang.String]) { PdgModule.setCdg(job.propertyMap, cdg) }
      def cdg : org.sireum.alir.ControlDependenceGraph[java.lang.String] = PdgModule.getCdg(job.propertyMap)

      def procedureSymbolTable_=(procedureSymbolTable : org.sireum.pilar.symbol.ProcedureSymbolTable) { PdgModule.setProcedureSymbolTable(job.propertyMap, procedureSymbolTable) }
      def procedureSymbolTable : org.sireum.pilar.symbol.ProcedureSymbolTable = PdgModule.getProcedureSymbolTable(job.propertyMap)

      def pdg_=(pdg : org.sireum.alir.ProgramDependenceGraph[java.lang.String]) { PdgModule.setPdg(job.propertyMap, pdg) }
      def pdg : org.sireum.alir.ProgramDependenceGraph[java.lang.String] = PdgModule.getPdg(job.propertyMap)
    }
  }
}

...
""".trim
      ...
      parseModeHelper("launch", Seq("bakar", "sireumdev", "compilerdev", "antlrworks", "bakarv1gps", "bakargps", "eclipse", "osate"), args, i) {
        _ match {
          case "bakar" =>
...
""".trim
      ...
      parseModeHelper("tools", Seq("jvm", "pipeline", "antlr", "sapper", "cligen"), args, i) {
        _ match {
          case "jvm" =>
...
""".trim
      ...
      parseModeHelper("sireum", Seq("bakar", "distro", "launch", "tools"), args, i) {
        _ match {
          case "bakar" =>

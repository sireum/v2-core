...
""".trim
    ...
    parseModeHelper("launch", Seq("bakar", "bakargps", "sireumdev", "osate", "eclipse", "compilerdev", "antlrworks", "bakarv1gps"), args, i) {
      _ match {
        case "bakar" =>
...
""".trim
    ...
    parseModeHelper("tools", Seq("jvm", "cligen", "antlr", "pipeline", "sapper"), args, i) {
      _ match {
        case "jvm" =>

...
""".trim
    ...
    parseModeHelper("launch", Seq("bakar", "sireumdev", "eclipse", "antlrworks", "bakargps", "osate", "bakarv1gps", "compilerdev"), args, i) {
      _ match {
        case "bakar" =>
...
""".trim
    ...
    parseModeHelper("sireum", Seq("x", "launch", "tools", "distro", "bakar"), args, i) {
      _ match {
        case "x" =>

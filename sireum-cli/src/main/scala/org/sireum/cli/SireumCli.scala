...
""".trim
    ...
    parseModeHelper("launch", Seq("bakar", "eclipse", "sireumdev", "compilerdev", "antlrworks", "bakarv1gps", "bakargps"), args, i) {
      _ match {
        case "bakar" =>
...
""".trim
    ...
    parseModeHelper("tools", Seq("cligen", "sapper", "antlr", "pipeline"), args, i) {
      _ match {
        case "cligen" =>

...
""".trim
    ...
    parseModeHelper("launch", Seq("eclipse", "sireumdev", "compilerdev", "antlrworks", "bakarv1gps", "bakargps", "osate", "bakar"), args, i) {
      _ match {
        case "eclipse" =>
...
""".trim
    ...
    parseModeHelper("sireum", Seq("x", "bakar", "tools", "distro", "launch"), args, i) {
      _ match {
        case "x" =>

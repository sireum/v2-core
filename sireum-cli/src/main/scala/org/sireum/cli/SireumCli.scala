...
""".trim
      ...
      parseModeHelper("launch", Seq("bakar", "bakargps", "sireumdev", "compilerdev", "antlrworks", "bakarv1gps", "osate", "eclipse"), args, i) {
        _ match {
          case "bakar" =>
...
""".trim
      ...
      parseModeHelper("tools", Seq("cligen", "jvm", "antlr", "pipeline", "sapper"), args, i) {
        _ match {
          case "cligen" =>
...
""".trim
      ...
      parseModeHelper("sireum", Seq("x", "launch", "distro", "tools", "bakar"), args, i) {
        _ match {
          case "x" =>

...
""".trim
    ...
    parseModeHelper("tools", Seq("antlr", "pipeline", "sapper", "cligen"), args, i) {
      _ match {
        case "antlr" =>
...
""".trim
    ...
    parseModeHelper("launch", Seq("bakar", "osate", "eclipse", "sireumdev", "compilerdev", "antlrworks", "bakarv1gps", "bakargps"), args, i) {
      _ match {
        case "bakar" =>
...
""".trim
    ...
    parseModeHelper("sireum", Seq("tools", "distro", "launch", "bakar"), args, i) {
      _ match {
        case "tools" =>

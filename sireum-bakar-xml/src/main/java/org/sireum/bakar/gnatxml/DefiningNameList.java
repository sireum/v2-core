...
/**
 * <p>
 * Java class for Defining_Name_List complex type.
 * 
 * <p>
...
@XmlType(name = "Defining_Name_List", propOrder = { "definingNames" })
public class DefiningNameList {
   ...
   * for the definingNames property.
   * 
   * <p>
  ...
  public List<Object> getDefiningNames() {
    if (this.definingNames == null) {
      this.definingNames = new ArrayList<Object>();
    }

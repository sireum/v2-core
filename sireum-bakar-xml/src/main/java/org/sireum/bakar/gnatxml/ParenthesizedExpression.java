...
/**
 * <p>
 * Java class for Parenthesized_Expression complex type.
 * 
 * <p>
...
@XmlType(name = "Parenthesized_Expression", propOrder = { "sloc",
...
public class ParenthesizedExpression {
  ...
  public ExpressionClass getExpressionParenthesizedQ() {
    return this.expressionParenthesizedQ;
  }
   ...
   * 
   */
  public void setExpressionParenthesizedQ(final ExpressionClass value) {

...
/**
 * <p>
 * Java class for Qualified_Expression complex type.
 * 
 * <p>
...
@XmlType(name = "Qualified_Expression", propOrder = { "sloc",
    "convertedOrQualifiedSubtypeMarkQ", "convertedOrQualifiedExpressionQ" })
public class QualifiedExpression {
  ...
  public ExpressionClass getConvertedOrQualifiedExpressionQ() {
    return this.convertedOrQualifiedExpressionQ;
  }
  ...
  public ExpressionClass getConvertedOrQualifiedSubtypeMarkQ() {
    return this.convertedOrQualifiedSubtypeMarkQ;
  }
   ...
   * 
   */
  public void setConvertedOrQualifiedExpressionQ(final ExpressionClass value) {
   ...
   * 
   */
  public void setConvertedOrQualifiedSubtypeMarkQ(final ExpressionClass value) {

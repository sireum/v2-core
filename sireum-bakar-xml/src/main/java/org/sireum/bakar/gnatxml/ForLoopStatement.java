...
/**
 * <p>
 * Java class for For_Loop_Statement complex type.
 * 
 * <p>
...
@XmlType(name = "For_Loop_Statement", propOrder = { "sloc", "labelNamesQl",
    "statementIdentifierQ", "forLoopParameterSpecificationQ",
    "loopStatementsQl" })
public class ForLoopStatement {
  ...
  public DeclarationClass getForLoopParameterSpecificationQ() {
    return this.forLoopParameterSpecificationQ;
  }
   ...
   * 
   */
  public void setForLoopParameterSpecificationQ(final DeclarationClass value) {
   ...
   * 
   */
  public void setLoopStatementsQl(final StatementList value) {

...
/**
 * <p>
 * Java class for Single_Task_Declaration complex type.
 * 
 * <p>
...
@XmlType(name = "Single_Task_Declaration", propOrder = { "sloc", "namesQl",
    "aspectSpecificationsQl", "declarationInterfaceListQl",
...
public class SingleTaskDeclaration {
  ...
  public ExpressionList getDeclarationInterfaceListQl() {
    return this.declarationInterfaceListQl;
  }
   ...
   * 
   */
  public void setDeclarationInterfaceListQl(final ExpressionList value) {

...
/**
 * <p>
 * Java class for Discrete_Range_List complex type.
 * 
 * <p>
...
@XmlType(name = "Discrete_Range_List", propOrder = { "discreteRanges" })
public class DiscreteRangeList {
   ...
   * for the discreteRanges property.
   * 
   * <p>
   ...
   * {@link NotAnElement } {@link DiscreteSubtypeIndication }
  ...
  public List<Object> getDiscreteRanges() {
    if (this.discreteRanges == null) {
      this.discreteRanges = new ArrayList<Object>();
    }

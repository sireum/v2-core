...
/**
 * <p>
 * Java class for Accept_Statement complex type.
 * 
 * <p>
...
@XmlType(name = "Accept_Statement", propOrder = { "sloc", "labelNamesQl",
    "acceptEntryDirectNameQ", "acceptEntryIndexQ", "acceptParametersQl",
    "acceptBodyStatementsQl", "acceptBodyExceptionHandlersQl" })
public class AcceptStatement {
  ...
  public StatementList getAcceptBodyExceptionHandlersQl() {
    return this.acceptBodyExceptionHandlersQl;
  }
  ...
  public StatementList getAcceptBodyStatementsQl() {
    return this.acceptBodyStatementsQl;
  }
  ...
  public NameClass getAcceptEntryDirectNameQ() {
    return this.acceptEntryDirectNameQ;
  }
  ...
  public ParameterSpecificationList getAcceptParametersQl() {
    return this.acceptParametersQl;
  }
   ...
   * 
   */
  public void setAcceptBodyExceptionHandlersQl(final StatementList value) {
   ...
   * 
   */
  public void setAcceptBodyStatementsQl(final StatementList value) {
   ...
   * 
   */
  public void setAcceptEntryDirectNameQ(final NameClass value) {
   ...
   * 
   */
  public void setAcceptEntryIndexQ(final ExpressionClass value) {
   ...
   * 
   */
  public void setAcceptParametersQl(final ParameterSpecificationList value) {

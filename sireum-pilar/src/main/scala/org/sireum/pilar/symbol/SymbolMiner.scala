...
trait ConstMiner extends SymbolMiner {
  ...
  def constElementSymbol(constElement : ConstElement,
    ...
    cet.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_CONST_ELEMENT,
          other)
      case _ =>
...
trait EnumMiner extends SymbolMiner {
  ...
  def enumElementSymbol(enumElement : EnumElement,
    ...
    eet.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_ENUM_ELEMENT,
          other)
      case _ =>
...
trait ExtensionMiner extends SymbolMiner {
  ...
  def extElementSymbol(extElement : ExtElement,
    ...
    eet.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef,
          DUPLICATE_EXTENSION_ELEMENT, other)
      case _ =>
...
trait FunMiner extends SymbolMiner {
  ...
  def funSymbol(funDecl : FunDecl,
    ...
    ft.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_FUN, other)
      case _ =>
...
trait GlobalVarMiner extends SymbolMiner {
  ...
  def globalVarSymbol(globalVarDecl : GlobalVarDecl,
    ...
    gvt.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_GLOBAL_VAR,
          other)
      case _ =>
...
trait ProcedureMiner extends SymbolMiner {
  ...
  def procedureSymbol(procedureDecl : ProcedureDecl,
    ...
    pat.get(absKey) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_PROCEDURE,
          other)
      case _ =>
        pds += absKey.intern
...
trait RecordMiner extends SymbolMiner {
  ...
  def recordAttributeSymbol(attribute : AttributeDecl,
    ...
    at.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_ATTRIBUTE,
          other)
      case _ =>
  ...
  def recordSymbol(recordDecl : RecordDecl,
    ...
    rt.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_RECORD,
          other)
      case _ =>
...
trait TypeAliasMiner extends SymbolMiner {
  ...
  def typeAliasSymbol(typeAliasDecl : TypeAliasDecl,
    ...
    tat.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_TYPE_ALIAS,
          other)
      case _ =>
...
trait VsetMiner extends SymbolMiner {
  ...
  def vsetSymbol(vsetDecl : VSetDecl,
    ...
    vt.get(key) match {
      case Some(other) =>
        reportRedeclaration(locPropKey, nameDef, DUPLICATE_VSET,
          other)
      case _ =>
  ...
  def localVarSymbol(localVar : LocalVar,
    ...
    lvt.get(key) match {
      case Some(other) =>
        ...
        symbolTableProducer.reportRedeclaration(locPropKey, nameDef, msg,
          other)
      case _ =>
      ...
      case Some(nameDef) =>
        ...
        lt.get(key) match {
          case Some(other) =>
            ...
            symbolTableProducer.reportRedeclaration(locPropKey, nameDef,
              DUPLICATE_LOCATION, otherSymDef)
          case _ =>
            lt(key.intern) = loc
            loc.index(index)
